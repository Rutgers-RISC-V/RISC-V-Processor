...
module RV32I_1_pc_logic_0_0(clk, clk_en, rst, debug_enable, debug_next_instr, 
  control_mux_next_pc, output_bus, pc, pc_plus_4)
/* synthesis syn_black_box black_box_pad_pin="clk,clk_en,rst,debug_enable,debug_next_instr,control_mux_next_pc[1:0],output_bus[31:0],pc[31:0],pc_plus_4[31:0]" */;
  input clk;
  input clk_en;
  input rst;
  input debug_enable;
