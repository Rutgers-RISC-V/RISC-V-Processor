...
//               project.srcs/sources_1/bd/RV32I_1/ip/RV32I_1_registers_0_0/RV32I_1_registers_0_0_stub.v}
...
module RV32I_1_registers_0_0(clk, clk_en, instr, reg_write_input, reg_1_out, 
  reg_2_out, wen, debug_leds)
/* synthesis syn_black_box black_box_pad_pin="clk,clk_en,instr[31:0],reg_write_input[31:0],reg_1_out[31:0],reg_2_out[31:0],wen,debug_leds[3:0]" */;
  input clk;
  input clk_en;
  input [31:0]instr;
