...
vlog -work xil_defaultlib -64 -incr -sv "+incdir+../../../../risc_v_test project.srcs/sources_1/bd/RV32I_pipelined/ipshared/85a3" \
...
vlog -work blk_mem_gen_v8_4_2 -64 -incr "+incdir+../../../../risc_v_test project.srcs/sources_1/bd/RV32I_pipelined/ipshared/85a3" \
"../../../../risc_v_test project.srcs/sources_1/bd/RV32I_pipelined/ipshared/37c2/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib -64 -incr "+incdir+../../../../risc_v_test project.srcs/sources_1/bd/RV32I_pipelined/ipshared/85a3" \
