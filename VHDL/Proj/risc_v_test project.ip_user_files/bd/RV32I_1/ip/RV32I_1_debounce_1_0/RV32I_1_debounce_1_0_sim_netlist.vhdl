...
--               project.srcs/sources_1/bd/RV32I_1/ip/RV32I_1_debounce_1_0/RV32I_1_debounce_1_0_sim_netlist.vhdl}
...
entity RV32I_1_debounce_1_0_debounce is
  port (
    dbnc : out STD_LOGIC;
    clk : in STD_LOGIC;
    btn : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME of RV32I_1_debounce_1_0_debounce : entity is "debounce";
end RV32I_1_debounce_1_0_debounce;

architecture STRUCTURE of RV32I_1_debounce_1_0_debounce is
  ...
  attribute SOFT_HLUTNM of \counter[14]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \counter[22]_i_2\ : label is "soft_lutpair10";
...
\counter[22]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity RV32I_1_debounce_1_0 is
  port (
    btn : in STD_LOGIC;
    clk : in STD_LOGIC;
    dbnc : out STD_LOGIC
  ...
  attribute NotValidForBitStream of RV32I_1_debounce_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of RV32I_1_debounce_1_0 : entity is "RV32I_1_debounce_1_0,debounce,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of RV32I_1_debounce_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of RV32I_1_debounce_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of RV32I_1_debounce_1_0 : entity is "debounce,Vivado 2018.3";
end RV32I_1_debounce_1_0;

architecture STRUCTURE of RV32I_1_debounce_1_0 is
...
begin
U0: entity work.RV32I_1_debounce_1_0_debounce
     port map (
      btn => btn,
      clk => clk,
      dbnc => dbnc
