...
li x24 35168 #23768+2400 #used for reset

li x23 4294967055 #used for reset
li x28 88 # load x into x28
...
blt x27 x6 resetl #undo location change
sb x28 0(x27)  	#store the number at location x27
j wait
...
blt x27 x6 resetu #undo location change
sb x28 0(x27)  	#store the number at location x27
j wait
...
addi x27 x27 80 #modify location to one square down
bge x27 x24 resetd #undo location change
sb  x28 0(x27)  	#store the number at location x27
j wait
...
addi x27 x27 1 #modify location to one square right
bge x27 x24 resetr #undo location change
sb x28 0(x27)  	#store the number at location x27
j wait
