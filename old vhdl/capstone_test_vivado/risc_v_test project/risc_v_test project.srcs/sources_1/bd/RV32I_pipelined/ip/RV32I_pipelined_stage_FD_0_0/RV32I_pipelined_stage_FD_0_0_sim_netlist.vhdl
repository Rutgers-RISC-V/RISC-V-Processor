...
architecture STRUCTURE of RV32I_pipelined_stage_FD_0_0_stage_FD is
  ...
  signal instruction_clear_out0_n_0 : STD_LOGIC;
  signal instruction_clear_out_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of PC_FD_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of instruction_clear_out_i_1 : label is "soft_lutpair0";
begin
  PC_FD <= \^pc_fd\;
...
instruction_clear_out0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"11111110"
    )
        port map (
      ...
      I3 => hazard(0),
      I4 => hazard(1),
      O => instruction_clear_out0_n_0
    );
instruction_clear_out_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => instruction_clear_out0_n_0,
      I1 => clk_en,
      I2 => \^instruction_clear_out\,
