...
ISEStep( "vivado",
         "-log RV32I_pipelined_pre_memory_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_pipelined_pre_memory_logic_0_0.tcl" );
