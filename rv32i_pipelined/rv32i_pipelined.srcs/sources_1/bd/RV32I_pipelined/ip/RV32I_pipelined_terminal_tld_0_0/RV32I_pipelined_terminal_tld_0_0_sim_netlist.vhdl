...
architecture STRUCTURE of RV32I_pipelined_terminal_tld_0_0_vga_ctrl is
  ...
  signal \base_mem_addr[3]_i_7_n_0\ : STD_LOGIC;
  ...
  signal tcount_i_1_n_0 : STD_LOGIC;
  signal \^terminal_count\ : STD_LOGIC;
  signal vertical_count0 : STD_LOGIC;
  signal \vertical_count[0]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[1]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[2]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[3]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[4]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[6]_i_1_n_0\ : STD_LOGIC;
  signal \vertical_count[7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \R[4]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \base_mem_addr[3]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of display_on_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \horizontal_count[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \horizontal_count[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \horizontal_count[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \horizontal_count[4]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \horizontal_count[9]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \horizontal_count[9]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of hsync_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of hsync_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \memory_addr[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \memory_addr[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \memory_addr[31]_i_10\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \memory_addr[31]_i_12\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \vertical_count[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \vertical_count[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \vertical_count[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vertical_count[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \vertical_count[8]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \vertical_count[9]_i_3\ : label is "soft_lutpair5";
...
\base_mem_addr[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \vertical_count[9]_i_3_n_0\,
      I4 => \base_mem_addr[3]_i_3_n_0\,
      I5 => \memory_addr[31]_i_4_n_0\,
      O => base_mem_addr0
    );
\base_mem_addr[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\base_mem_addr[3]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\base_mem_addr[3]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\base_mem_addr_reg[3]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \base_mem_addr[3]_i_4_n_0\,
      DI(2) => '0',
      DI(1) => \base_mem_addr[3]_i_5_n_0\,
      DI(0) => '0',
      ...
      S(3) => \base_mem_addr[3]_i_6_n_0\,
      S(2) => base_mem_addr_reg(5),
      S(1) => \base_mem_addr[3]_i_7_n_0\,
...
display_on_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FF0CFFFFAAAAAAAA"
    )
        port map (
      I0 => vid_on,
      I1 => \memory_addr[31]_i_6_n_0\,
      I2 => display_on_i_2_n_0,
      I3 => \memory_addr[31]_i_8_n_0\,
      I4 => \memory_addr[31]_i_9_n_0\,
      I5 => clk_en,
      O => display_on_i_1_n_0
    );
display_on_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EAAAAAAA"
    )
        port map (
...
\memory_addr[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
      I0 => \memory_addr[31]_i_8_n_0\,
      I1 => \memory_addr[31]_i_9_n_0\,
      I2 => \memory_addr[3]_i_2_n_0\,
      I3 => memory_horizontal_count_reg(3),
      O => p_2_out(0)
    );
\memory_addr[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
      ...
      I1 => \memory_addr[31]_i_9_n_0\,
      I2 => \memory_addr[3]_i_2_n_0\,
      I3 => memory_horizontal_count_reg(4),
      O => p_2_out(1)
    );
\memory_addr[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
      ...
      I1 => \memory_addr[31]_i_9_n_0\,
      I2 => \memory_addr[3]_i_2_n_0\,
      I3 => memory_horizontal_count_reg(5),
      O => p_2_out(2)
    );
...
\memory_addr[31]_i_10\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFFFFFF"
    )
        port map (
...
\memory_addr[31]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFF2FF0000"
    )
        port map (
      I0 => \memory_addr[31]_i_6_n_0\,
      I1 => \memory_addr[31]_i_7_n_0\,
      I2 => \memory_addr[31]_i_8_n_0\,
      I3 => \memory_addr[31]_i_9_n_0\,
      I4 => clk_en,
      I5 => base_mem_addr0,
      O => \memory_addr[31]_i_2_n_0\
    );
\memory_addr[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\memory_addr[31]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000011115515"
        ...
        port map (
      I0 => vsync_i_2_n_0,
      I1 => \base_mem_addr[3]_i_3_n_0\,
      I2 => \vertical_count_reg_n_0_[4]\,
      I3 => \vertical_count[8]_i_2_n_0\,
      I4 => \vertical_count_reg_n_0_[5]\,
      I5 => \vertical_count_reg_n_0_[9]\,
      O => \memory_addr[31]_i_8_n_0\
    );
\memory_addr[31]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => vsync_i_2_n_0,
      I1 => \memory_addr[31]_i_5_n_0\,
      O => \memory_addr[31]_i_9_n_0\
    );
\memory_addr[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA6AAA"
    )
        port map (
...
\memory_addr[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \memory_addr[31]_i_8_n_0\,
      I4 => \memory_addr[31]_i_9_n_0\,
      I5 => memory_horizontal_count_reg(9),
      O => \memory_addr[6]_i_2_n_0\
    );
\memory_addr[6]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA6AAA"
    )
        port map (
...
\memory_addr[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9AAAAAAA9A55AA55"
    )
        port map (
      I0 => base_mem_addr_reg(4),
      I1 => \memory_addr[31]_i_8_n_0\,
      I2 => \memory_addr[31]_i_9_n_0\,
      I3 => \memory_addr[3]_i_2_n_0\,
      I4 => memory_horizontal_count_reg(7),
      I5 => \vertical_count[8]_i_2_n_0\,
      O => \memory_addr[6]_i_4_n_0\
    );
\memory_addr[6]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAA6AAA"
    )
        port map (
...
\memory_horizontal_count[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20220000"
    )
        port map (
...
tcount_i_1: unisim.vcomponents.LUT6
    generic map(
...
tcount_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\vertical_count[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \memory_addr[31]_i_9_n_0\,
      I1 => \^vertical_count_reg[3]_0\(0),
      O => \vertical_count[0]_i_1_n_0\
    );
\vertical_count[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
      ...
      O => \vertical_count[1]_i_1_n_0\
    );
\vertical_count[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2A80"
    )
        port map (
...
\vertical_count[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"28888888"
    )
        port map (
      ...
      O => \vertical_count[3]_i_1_n_0\
    );
\vertical_count[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\vertical_count[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"88288888"
    )
        port map (
      ...
      O => \vertical_count[6]_i_1_n_0\
    );
\vertical_count[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\vertical_count[9]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => horizontal_count0,
      I1 => \memory_addr[31]_i_9_n_0\,
      O => vertical_count0
    );
...
vsync_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => horz_cnt(7),
      I4 => horz_cnt(6),
      I5 => \horizontal_count[9]_i_3_n_0\,
      O => vsync_i_2_n_0
    );
...
vga: entity work.RV32I_pipelined_terminal_tld_0_0_vga_ctrl
     port map (
      ...
      clk => clk,
      clk_en => clk_en,
      \horizontal_count_reg[2]_0\ => vga_n_9,
      terminal_count => terminal_count,
