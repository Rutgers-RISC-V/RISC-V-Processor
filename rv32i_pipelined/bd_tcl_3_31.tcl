...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_2 [get_bd_ports clk] [get_bd_pins clock_div_0/clk] [get_bd_pins debounce_0/clk] [get_bd_pins hazard_count_0/clk] [get_bd_pins program_counter_1/clk] [get_bd_pins registers_0/clk] [get_bd_pins stage_DE_0/clk] [get_bd_pins stage_EM_0/clk] [get_bd_pins stage_FD_0/clk] [get_bd_pins stage_MW_0/clk]
  connect_bd_net -net clock_div_0_div_clk [get_bd_pins clock_div_0/div_clk] [get_bd_pins hazard_count_0/clk_en] [get_bd_pins program_counter_1/clk_en] [get_bd_pins registers_0/clk_en] [get_bd_pins stage_DE_0/clk_en] [get_bd_pins stage_EM_0/clk_en] [get_bd_pins stage_FD_0/clk_en] [get_bd_pins stage_MW_0/clk_en]
  ...
  connect_bd_net -net program_counter_0_PC [get_bd_pins pc_logic_0/PC] [get_bd_pins program_counter_1/PC] [get_bd_pins stage_FD_0/PC]
  ...
  connect_bd_net -net stage_DE_0_control_alu_DE [get_bd_pins ALU_0/control_alu] [get_bd_pins stage_DE_0/control_alu_DE]
  ...
  connect_bd_net -net stage_DE_0_reg_2_DE [get_bd_pins mux_reg_descr_alu_0/reg_2_out] [get_bd_pins stage_DE_0/reg_2_DE]
