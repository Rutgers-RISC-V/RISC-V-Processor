...
//               project.srcs/sources_1/bd/RV32I_pipelined/ip/RV32I_pipelined_stage_DE_0_0/RV32I_pipelined_stage_DE_0_0_stub.v}
...
module RV32I_pipelined_stage_DE_0_0(clk, clk_en, rst_counter, branch_logic, 
  hazard_logic, pc_FD, control_branch_FD, mux_reg_pc_alu_FD, mux_reg_descr_alu_FD, 
  mux_output_FD, mux_reg_write_FD, control_mem_logic_FD, control_alu_FD, 
  control_reg_writeenable_FD, reg_1_FD, reg_2_FD, immediate_FD, instruction_FD, pc_DE, 
  control_branch_DE, mux_reg_pc_alu_DE, mux_reg_descr_alu_DE, mux_output_DE, 
  mux_reg_write_DE, control_mem_logic_DE, control_alu_DE, control_reg_writeenable_DE, 
  reg_1_DE, reg_2_DE, immediate_DE, instruction_DE)
/* synthesis syn_black_box black_box_pad_pin="clk,clk_en,rst_counter[1:0],branch_logic,hazard_logic,pc_FD[31:0],control_branch_FD[3:0],mux_reg_pc_alu_FD,mux_reg_descr_alu_FD,mux_output_FD,mux_reg_write_FD[1:0],control_mem_logic_FD[3:0],control_alu_FD[3:0],control_reg_writeenable_FD,reg_1_FD[31:0],reg_2_FD[31:0],immediate_FD[31:0],instruction_FD[31:0],pc_DE[31:0],control_branch_DE[3:0],mux_reg_pc_alu_DE,mux_reg_descr_alu_DE,mux_output_DE,mux_reg_write_DE[1:0],control_mem_logic_DE[3:0],control_alu_DE[3:0],control_reg_writeenable_DE,reg_1_DE[31:0],reg_2_DE[31:0],immediate_DE[31:0],instruction_DE[31:0]" */;
  input clk;
  input clk_en;
