...
--               Bejerano/PycharmProjects/RISC-V-Processor/terminal/terminal.srcs/sources_1/bd/design_1/ip/design_1_terminal_top_0_0/design_1_terminal_top_0_0_sim_netlist.vhdl}
...
entity design_1_terminal_top_0_0_Font_Rom_Addr_Gen is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_Font_Rom_Addr_Gen : entity is "Font_Rom_Addr_Gen";
end design_1_terminal_top_0_0_Font_Rom_Addr_Gen;

architecture STRUCTURE of design_1_terminal_top_0_0_Font_Rom_Addr_Gen is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_character_memaddress is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_character_memaddress : entity is "character_memaddress";
end design_1_terminal_top_0_0_character_memaddress;

architecture STRUCTURE of design_1_terminal_top_0_0_character_memaddress is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_clock_div is
  port (
    clk_div : out STD_LOGIC;
    clk : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_clock_div : entity is "clock_div";
end design_1_terminal_top_0_0_clock_div;

architecture STRUCTURE of design_1_terminal_top_0_0_clock_div is
...
div_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
div_i_4: unisim.vcomponents.LUT6
    generic map(
...
div_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_fontROM is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_fontROM : entity is "fontROM";
end design_1_terminal_top_0_0_fontROM;

architecture STRUCTURE of design_1_terminal_top_0_0_fontROM is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_pixel_pusher is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_pixel_pusher : entity is "pixel_pusher";
end design_1_terminal_top_0_0_pixel_pusher;

architecture STRUCTURE of design_1_terminal_top_0_0_pixel_pusher is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_vga_ctrl is
  port (
    HS : out STD_LOGIC;
    VS : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_vga_ctrl : entity is "vga_ctrl";
end design_1_terminal_top_0_0_vga_ctrl;

architecture STRUCTURE of design_1_terminal_top_0_0_vga_ctrl is
  signal \^hs\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_terminal_top_0_0_terminal_top is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_terminal_top_0_0_terminal_top : entity is "terminal_top";
end design_1_terminal_top_0_0_terminal_top;

architecture STRUCTURE of design_1_terminal_top_0_0_terminal_top is
...
begin
  clk_div <= \^clk_div\;
Font_Addr_Gen: entity work.design_1_terminal_top_0_0_Font_Rom_Addr_Gen
     port map (
...
PixelOut: entity work.design_1_terminal_top_0_0_pixel_pusher
     port map (
      G(0) => G(0),
      \R_reg[4]_0\ => vgacontrol_n_11,
      clk => clk
    );
address_generator: entity work.design_1_terminal_top_0_0_character_memaddress
     port map (
...
div: entity work.design_1_terminal_top_0_0_clock_div
     port map (
      clk => clk,
      clk_div => \^clk_div\
    );
font: entity work.design_1_terminal_top_0_0_fontROM
     port map (
...
vgacontrol: entity work.design_1_terminal_top_0_0_vga_ctrl
     port map (
      ADDRARDADDR(8 downto 0) => addrA(8 downto 0),
      DOADO(3) => character_Strip(7),
      DOADO(2) => character_Strip(5),
...
entity design_1_terminal_top_0_0 is
  ...
  attribute NotValidForBitStream of design_1_terminal_top_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_terminal_top_0_0 : entity is "design_1_terminal_top_0_0,terminal_top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_terminal_top_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_terminal_top_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_terminal_top_0_0 : entity is "terminal_top,Vivado 2018.3";
end design_1_terminal_top_0_0;

architecture STRUCTURE of design_1_terminal_top_0_0 is
...
U0: entity work.design_1_terminal_top_0_0_terminal_top
     port map (
      G(0) => \^g\(5),
      HS => HS,
      VS => VS,
