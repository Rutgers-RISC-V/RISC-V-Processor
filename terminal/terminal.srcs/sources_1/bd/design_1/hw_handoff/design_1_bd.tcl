...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins terminal_top_0/ascii_in]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins terminal_top_0/clk]
  ...
  connect_bd_net -net terminal_top_0_clk_div [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins terminal_top_0/clk_div]
  connect_bd_net -net terminal_top_0_memaddr [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins terminal_top_0/memaddr]
